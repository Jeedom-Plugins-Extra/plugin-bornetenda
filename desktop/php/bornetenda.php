...
sendVarToJS('eqType', 'bornetenda');
$eqLogics = eqLogic::byType('bornetenda');
?>
    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter une borne}}</a>
		...
		<div class="eqLogicThumbnailContainer">
			...
			if (count($eqLogics) == 0) {
                ...
                foreach ($eqLogics as $eqLogic) {
                    ...
                    echo "<center>";
                    echo '<img src="plugins/bornetenda/doc/images/bornetenda_icon.png" height="105" width="95" />';
                    echo "</center>";
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de la borne borne tenda}}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{Compte de la borne tenda}}</label>
                    <div class="col-lg-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="username"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{Password de la borne tenda}}</label>
                    <div class="col-lg-3">
